...
INSERT INTO `Blood_Bank_186` (`bb_id`, `bb_name`, `bb_street`, `bb_building_no`, `bb_locality`) VALUES
...
CREATE TABLE `Blood_Patient_186` (
  `bu_id` varchar(4) NOT NULL,
  `patient_id` varchar(5) NOT NULL,
  `blood_group` varchar(4) NOT NULL
);

INSERT INTO `Blood_Patient_186` (`bu_id`, `patient_id`, `blood_group`) VALUES
('120', 'P0010', 'AB+'),
('120', 'P0014', 'O+'),
('117', 'P0016', 'O-'),
('111', 'P0024', 'A+'),
...
CREATE TABLE `Blood_Units_186` (
  `bu_id` varchar(4) NOT NULL,
  `blood_group` varchar(4) NOT NULL,
  `bb_id` int(4) NOT NULL
);

INSERT INTO `Blood_Units_186` (`bu_id`, `blood_group`, `bb_id`) VALUES
('111', 'A+', 1000),
('112', 'A-', 1000),
('113', 'B+', 1000),
('114', 'AB+', 1000),
...
INSERT INTO `Donor_186` (`d_id`, `d_name`, `d_surname`, `d_gender`, `blood_group`, `contact_no`, `d_street`, `d_house_number`, `d_locality`, `d_age`, `d_disease`, `id_blood`, `bloodGroup_Blood`, `id_rt`, `date_register`) VALUES
...
INSERT INTO `Hospital_186` (`hospital_id`, `h_name`, `h_street`, `h_building_no`, `h_locality`) VALUES
...
CREATE TABLE `Hospital_Request_186` (
  `request_id` int(4) NOT NULL,
  `hospital_id` varchar(4) NOT NULL
);

INSERT INTO `Hospital_Request_186` (`request_id`, `hospital_id`) VALUES
(2, 'H030'),
(4, 'H031'),
(6, 'H032'),
(8, 'H033'),
...
INSERT INTO `Patient_186` (`patient_id`, `patient_name`, `patient_surname`, `gender`, `blood_group`, `contact`, `street`, `house_number`, `locality`, `rt_id`, `date_registration`) VALUES
...
CREATE TABLE `Patient_Request_186` (
  `patient_id` varchar(5) NOT NULL,
  `request_id` int(4) NOT NULL
);

INSERT INTO `Patient_Request_186` (`patient_id`, `request_id`) VALUES
('P0010', 1),
('P0010', 15),
('P0010', 17),
('P0011', 11),
...
CREATE TABLE `Registration_Team_186` (
...
INSERT INTO `Registration_Team_186` (`rt_member_id`, `rt_member_name`, `rt_member_surname`, `bb_id`) VALUES
...
CREATE TABLE `Requests_186` (
  `request_id` int(4) NOT NULL,
  `blood_group` varchar(4) NOT NULL,
  `units_of_blood` int(4) NOT NULL
);

INSERT INTO `Requests_186` (`request_id`, `blood_group`, `units_of_blood`) VALUES
(1, 'A', 1),
(2, 'AB+', 2),
(3, 'A+', 3),
(4, 'A-', 4),
...
CREATE TABLE `Technical_Analyst_186` (
...
INSERT INTO `Technical_Analyst_186` (`ta_id`, `ta_name`, `ta_surname`, `bb_id`) VALUES
...
CREATE TABLE `Technical_Analyst_Blood_186` (
  `ta_id` int(4) NOT NULL,
  `bu_id` varchar(10) NOT NULL,
  `blood_group` varchar(4) NOT NULL
);

INSERT INTO `Technical_Analyst_Blood_186` (`ta_id`, `bu_id`, `blood_group`) VALUES
(113, '112', 'A-'),
(911, '113', 'B+'),
(912, '114', 'AB+'),
(913, '115', 'A+'),
...
ALTER TABLE `Blood_Bank_186`
  ADD PRIMARY KEY (`bb_id`);

--
-- Indexes for table `Blood_Patient`
--
ALTER TABLE `Blood_Patient_186`
  ADD KEY `bu_id` (`bu_id`);

--
-- Indexes for table `Blood_Units`
--
ALTER TABLE `Blood_Units_186`
...
--
ALTER TABLE `Donor_186`
  ADD PRIMARY KEY (`d_id`);

--
-- Indexes for table `Hospital`
--
ALTER TABLE `Hospital_186`
  ADD PRIMARY KEY (`hospital_id`);

--
-- Indexes for table `Hospital_Request`
--
ALTER TABLE `Hospital_Request_186`
...
--
ALTER TABLE `Patient_Request_186`
...
--
ALTER TABLE `Registration_Team_186`
...
--
ALTER TABLE `Requests_186`
  ADD PRIMARY KEY (`request_id`);

--
-- Indexes for table `Technical_Analyst`
--
ALTER TABLE `Technical_Analyst_186`
...
--
ALTER TABLE `Technical_Analyst_Blood_186`
  ADD KEY `bu_id` (`bu_id`),
  ADD KEY `ta_id` (`ta_id`);
...
--
ALTER TABLE `Blood_Patient_186`
  ADD CONSTRAINT `blood_patient_ibfk_1` FOREIGN KEY (`bu_id`) REFERENCES `Blood_Units_186` (`bu_id`);

--
-- Constraints for table `Blood_Units`
--
ALTER TABLE `Blood_Units_186`
  ADD CONSTRAINT `blood_units_ibfk_1` FOREIGN KEY (`bb_id`) REFERENCES `Blood_Bank_186` (`bb_id`);

--
-- Constraints for table `Hospital_Request`
--
ALTER TABLE `Hospital_Request_186`
  ADD CONSTRAINT `hospital_request_ibfk_1` FOREIGN KEY (`hospital_id`) REFERENCES `Hospital_186` (`hospital_id`),
  ADD CONSTRAINT `hospital_request_ibfk_2` FOREIGN KEY (`request_id`) REFERENCES `Requests_186` (`request_id`);

--
-- Constraints for table `Patient`
--
ALTER TABLE `Patient_186`
  ADD CONSTRAINT `patient_ibfk_1` FOREIGN KEY (`rt_id`) REFERENCES `Registration_Team_186` (`rt_member_id`);

--
-- Constraints for table `Patient_Request`
--
ALTER TABLE `Patient_Request_186`
  ADD CONSTRAINT `patient_request_ibfk_1` FOREIGN KEY (`request_id`) REFERENCES `Requests_186` (`request_id`),
  ADD CONSTRAINT `patient_request_ibfk_2` FOREIGN KEY (`patient_id`) REFERENCES `Patient_186` (`patient_id`),
  ADD CONSTRAINT `patient_request_ibfk_3` FOREIGN KEY (`patient_id`) REFERENCES `Patient_186` (`patient_id`);

--
-- Constraints for table `Registration_Team`
--
ALTER TABLE `Registration_Team_186`
  ADD CONSTRAINT `fk_bb_rt` FOREIGN KEY (`bb_id`) REFERENCES `Blood_Bank_186` (`bb_id`);

--
-- Constraints for table `Technical_Analyst`
--
ALTER TABLE `Technical_Analyst_186`
  ADD CONSTRAINT `fk_bb_ta` FOREIGN KEY (`bb_id`) REFERENCES `Blood_Bank_186` (`bb_id`);

--
-- Constraints for table `Technical_Analyst_Blood`
--
ALTER TABLE `Technical_Analyst_Blood_186`
  ADD CONSTRAINT `technical_analyst_blood_ibfk_1` FOREIGN KEY (`bu_id`) REFERENCES `Blood_Units_186` (`bu_id`),
  ADD CONSTRAINT `technical_analyst_blood_ibfk_2` FOREIGN KEY (`ta_id`) REFERENCES `Technical_Analyst_186` (`ta_id`);
COMMIT;